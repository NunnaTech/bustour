					...
					<div className='mt-8 grid grid-cols-1 lg:grid-cols-2 gap-x-16 gap-y-12'>
						<blockquote>
							<header className='sm:items-center sm:flex'>
								...
								<p className='mt-2 font-medium sm:ml-4 sm:mt-0'>Luis Ortiz</p>
							</header>

							<p className='mt-2 text-gray-700'>Excelente opción para ir de viaje y/o solicitar transporte a cualquier parte de la republica con un precio super accesible!</p>
						...
						<blockquote>
							...
							<p className='mt-2 text-gray-700'>Buen servicio</p>
